...
|---|---|---|
| 🏘️ Ironwood | Village | Literature |
| 🏙️ Ashford | City | General History |
| 🏘️ Duskholm | Village | Science History |
| 🏘️ Millhaven | Village | Art |
| 🏙️ Stonekeep | City | Geography *(starting point)* |
| 🏘️ Brightwater | Village | Biology |
...
1. **Start on the map** — your knight stands at Stonekeep at the beginning of each game.
2. **Tap a connected settlement** to travel there and begin its quiz.
...
- Each quiz contains **12 questions** drawn from that settlement's topic.
- Every question is **multiple choice with 4 options**.
- You must reach the **passing score** to conquer a settlement.
- If you want to quit mid-quiz, tap the back button — you will be asked to confirm before returning to the map. Your progress in that quiz will be lost.
- You can **replay** any settlement's quiz to improve your score.
...
A small knight figure travels the map and always stands at your current settlement. Watch him move between nodes as you journey across the realm!
...
*Good luck, brave knight. The realm awaits your conquest!* ⚔️
